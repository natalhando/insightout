...
4. **A stronger analytical workflow.** I would add query/result caching, explicit citations of the queried fields and date range, and a compact history of the analysis steps so users can inspect and reproduce how an answer was produced.